...
public struct MCPPrompt: Sendable, MCPPromptProtocol {
    ...
    // public struct ExtractedPromptParameter {
    ...
    // public func extractPromptParameters(from input: String) -> [ExtractedPromptParameter] {
    //     var parameters: [ExtractedPromptParameter] = []
    ...
    //             parameters.append(ExtractedPromptParameter(name: name, description: description))
    //         }
    //     }
